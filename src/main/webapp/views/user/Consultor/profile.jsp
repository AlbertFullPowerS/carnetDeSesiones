...
<jsp:include page="../../../layouts/consultor/bodyUp.jsp"/>
        ...
        <div class="fondo">
            <div class="nombre-alumno  d-flex justify-content-around">
                <h4 class="txt-4-green"><c:out value="${consultor.name}"/> <c:out value="${consultor.first_last_name}"/> <c:out value="${consultor.second_last_name}"/></h4>
                <h4 class="txt-3-blue">Consultor</h4>
            </div>
            <div class="info txt-2-gray">
                <div>
                    <p>Correo</p>
                    <p class="txt-2-gray-v2"><c:out value="${consultor.email}"/></p>
                </div>
            </div>
            <form action="${pageContext.request.contextPath}/consultor/password-changes" id="forms" method="post" >
