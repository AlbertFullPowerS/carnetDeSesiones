    ...
    $(function(){
        ...
        switch(valueCard){
            case'1':
                      ...
                      <form action="${pageContext.request.contextPath}/admin/period/update" method="post">
                        <div class="input-group input-group-sm mb-3">

                          <input type="date" class="form-control card-input" id="inputGroup-sizing-sm" name="valor" placeholder="<c:out value="${op.valueView}"/>">
                      ...
                      <div class="d-flex justify-content-evenly">
                        <a href="${pageContext.request.contextPath}/admin/user-view-update-period" class="btn btn-secondary card-sm-btn">Cancelar</a>
