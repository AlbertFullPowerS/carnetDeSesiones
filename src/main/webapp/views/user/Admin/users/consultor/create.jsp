...
<jsp:include page="../../../../../layouts/admin/bodyUp.jsp"/>
            <div class="sm-t flex">
                <h2 class="txt-4-green" style="text-align: start; font-size: 1.2rem;">Consultor</h2>

            </div>
            <form action="${pageContext.request.contextPath}/admin/consultor/save" method="post">
                            ...
                            <div class="card card-uu card-padding flex-md-fill" >
                                <div class="card-body">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <span class="input-group-text" ><img src="Pencil.png" alt="" class="icon"></span>
                ...
                <div class="d-flex justify-content-evenly sm-t">
                    <a href="${pageContext.request.contextPath}/admin/consultor" class="btn  btn-dark btn-sm">Cancelar</a>
