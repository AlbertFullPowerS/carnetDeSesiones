            ...
            case'1':
                switch (idIf) {
                    ...
                    case "Email" :
                      ...
                      <form action="${pageContext.request.contextPath}/admin/consultor/update" method="post">
                      ...
                      <div class="d-flex justify-content-evenly">
                        <a href="${pageContext.request.contextPath}/admin/user-view-update-consultor" class="btn btn-secondary card-sm-btn">Cancelar</a>
