...
<jsp:include page="../../../../../layouts/admin/bodyUp.jsp"/>
            <div class="sm-t flex">
                <h2 class="txt-4-green" style="text-align: start; font-size: 1.2rem;">Tutor</h2>

            </div>
            <form action="${pageContext.request.contextPath}/admin/tutor/save" method="post">
                            ...
                            <div class="card card-uu card-padding flex-md-fill" >
                                <div class="card-body">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="email" required onchange="change()" class="form-control card-input" id="email" name="email" placeholder="ejmp@utez.edu.mx">
                                        <span class="input-group-text" ><img src="${pageContext.request.contextPath}/assets/img/Pencil.png" alt="" class="icon"></span>
                ...
                <div class="d-flex justify-content-evenly sm-t">
                    <a href="${pageContext.request.contextPath}/admin/tutor" class="btn  btn-dark btn-sm">Cancelar</a>
...
<script>
   ...
   function change(e)  {
        ...
        document.getElementById('password').value = nom.value.substring(1,3) + "U" + email.value.substring(1,3)
            + Math.floor(Math.random() * 100) + ap1.value.substring(1,3)+ ap2.value.substring(1,3)+ Math.floor(Math.random() * 100);
