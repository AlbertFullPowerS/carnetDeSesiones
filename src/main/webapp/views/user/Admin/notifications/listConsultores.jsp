...
<div class="content_list" id="content_list" >
    <div class="scroll">
        ...
        <table class="table table-borderless miTablaPersonalizada" id="miTabla" style="display: none;">
            ...
            <c:forEach var="consultor" items="${Consultors}" varStatus="s">
                <tr class="ancho-columna">
                    ...
                    <td><c:out value="${consultor.id_user}"/></td>
                </tr>
            </c:forEach>
        </table>
        ...
        <form action="${pageContext.request.contextPath}/admin/transfer" method="post" id="formCon">
            <input type="hidden" id="id_consultor" name="id_consultor">
        </form>
    </div>

</div>
</body>
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/notifications/ToolsListsCon.js"></script>
</html>