...
<jsp:include page="../../../layouts/tutor/bodyUp.jsp"/>
        ...
        <div class="fondo">
            <div class="nombre-alumno  d-flex justify-content-around">
                <h4 class="txt-4-green"><c:out value="${tutor.name}"/> <c:out value="${tutor.first_last_name}"/> <c:out value="${tutor.second_last_name}"/></h4>
                <h4 class="txt-3-blue">Tutor</h4>
            </div>
            <div class="info txt-2-gray">
                <div>
                    <p>Correo</p>
                    <p class="txt-2-gray-v2"><c:out value="${tutor.email}"/></p>
                </div>
            </div>
            <form action="${pageContext.request.contextPath}/tutor/password-changes" id="forms" method="post" >
